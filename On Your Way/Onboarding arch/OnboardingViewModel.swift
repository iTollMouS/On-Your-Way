...
enum OnboardingViewModel: Int, CaseIterable {
    ...
    var detailsLabel: String {
        switch self {
        case .cashOnDelivery: return "تستطيع زيادة دخلك الشهري من خلال سفرك بين المدن بواسطة شحن البضائع للعملاء على طريقك بدون اي تكلفة"
        ...
        case .discountPolicy: return "سياستنا هي ايصال اعلى معايير الجودة بمقابل عمولة 0% و ضمان حقوق المسافر و العميل"
